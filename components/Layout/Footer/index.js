          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="pb-6 col-span-full md:pb-0 md:col-span-4 px-4">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-secondary">21,22 Ganpati Vihar Colony, Rakdi, Sodala, Jaipur, Rajasthan - 302006</p>
              </div>
              <div className="mb-4">
                <p className="pb-2 text-xl cursor-pointer	 hover:text-primary f-heading">Follow Us</p>
                <div className="flex space-x-4 lg:pt-0 lg:col-end-13">
                  <a
                    rel="noopener noreferrer"
                    href="#"
                    title="Email"
            ...
            <div className="col-span-6 text-center md:text-left md:col-span-4 md:border-l border-secondary px-4">
              <p className="pb-4 text-xl cursor-pointer	 hover:text-primary f-heading">Learn More</p>
              <ul>
                {links.map(({ name, link }) => {
                  return (
                    <li key={link} className="mb-2">
                      <Link href={link}>
                        <a
                          rel="noopener noreferrer"
                          className="hover:dark:ml-2 duration-300 text-secondary"
                        >
                          {name}
                        </a>
                      </Link>
            ...
            <div className="col-span-6 text-center md:text-left md:col-span-4 md:border-l border-secondary px-4">
              <p className="pb-4 hover:text-primary text-xl cursor-pointer	 f-heading">Important Links</p>
              <ul>
                {impLinks.map(({ name, link }) => {
                  return (
                    <li key={link} className="mb-2">
                      <Link href={link}>
                        <a
